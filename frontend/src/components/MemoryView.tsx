...
import { History, MessageSquare, ArrowRight, Clock, ShieldCheck, Filter, X, ChevronRight, Sparkles, Check } from 'lucide-react';

interface MemoryViewProps {
    history: any[];
}

export default function MemoryView({ history }: MemoryViewProps) {
