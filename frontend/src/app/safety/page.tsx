    ...
    const safetyFeatures = [
        {
            ...
            desc: "All authentication tokens and sensitive metadata are encrypted at rest using industry-standard AES-256."
        },
        {
            icon: <EyeOff className="w-6 h-6 text-rose-400" />,
            title: "Zero Pixel Tracking",
            desc: "We never inject tracking pixels into your emails. Your interactions remain private and invisible to trackers."
        },
        {
            icon: <Key className="w-6 h-6 text-emerald-400" />,
            title: "BYOK Infrastructure",
            desc: "Optionally bring your own OpenAI or Gemini API keys to ensure data processing stays within your controlled environment."
        },
        {
            icon: <Shield className="w-6 h-6 text-indigo-400" />,
            title: "OAuth 2.0 Only",
            desc: "We never ask for your password. All access is managed through secure, revokable Google OAuth tokens."
        }
    ];
                ...
                <div className="max-w-5xl mx-auto space-y-24">
                    <div className="text-center space-y-4">
                        ...
                        <p className="text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed">
                            We've engineered SmartEmail to be the most secure email tool ever built. Our security model is "Deny-by-Default".
                        </p>
                    </div>
                    ...
                    <section className="glass-card p-8 md:p-12 bg-white/[0.02] border-indigo-500/10">
                        <div className="flex flex-col md:flex-row gap-12 items-center">
                            ...
                            <div className="space-y-4 flex-1">
                                <h2 className="text-2xl font-bold">Privacy Policy Enforcement</h2>
                                <p className="text-gray-400 leading-relaxed">
                                    Our AI models are strictly prohibited from storing or training on your content. Every request is isolated, and data is wiped from the inference engine once your summary or draft is generated.
                                </p>
                    ...
                    <div className="text-center py-12 border-t border-white/5 space-y-8">
                        <div className="flex flex-col items-center gap-4">
                            ...
                            <h2 className="text-3xl font-bold">Real-time Safety Audits</h2>
                            <p className="text-gray-500 max-w-lg mx-auto">
                                Our Trust Engine continuously monitors your connection integrity and encryption health. Check your status anytime in the sidebar.
                            </p>
                        </div>
